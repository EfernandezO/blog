<nav class="bg-gray-800" x-data="{openM:false}">
    <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
      <div class="relative flex items-center justify-between h-16">
        ...
        <div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
          ...
          <button x-on:click="openM=true" type="button" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-controls="mobile-menu" aria-expanded="false">
    ...
    <div class="sm:hidden" id="mobile-menu" x-show="openM" x-on:click.away="openM=false">
